...
class TrackballWild(TrackballOrbyl):
        ...
        hulls.append(
            triangle_hulls(
                [
                    ...
                    self.tr_place(web_post_br()),   # <- additional point
                ]
            )
        )
        hulls.append(
    ...
    def connection(self, side='right'):
        ...
        #             left_key_place(web_post(), lastrow - 2, -1, side=side, low_corner=True),                # left_key_place(translate(web_post(), wall_locate1(-1, 0)), cornerrow, -1, low_corner=True),
        #             self.track_place(self.tb_post_tl()),
        #         ]
        #     )
        # )
        ...
        hulls.append(
            triangle_hulls(
                [
                    self.tr_place(web_post_br()),
                    key_place(web_post_bl(), 3, lastrow),
                    key_place(translate(web_post_bl(), wall_locate1(0, -1)), 4, lastrow),
